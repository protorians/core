...
exports.CoreAnimation = void 0;
const foundation_1 = require("../foundation");
class CoreAnimation {
    get features() {
        return __classPrivateFieldGet(this, _CoreAnimation_features, "f");
    }
    ...
    calibrate(feature, property, value) {
        if (this.features[feature] != undefined) {
            const calibrate = Object.assign({}, __classPrivateFieldGet(this, _CoreAnimation_features, "f")[feature]);
            // @ts-ignore
    ...
    reset(target) {
        var _a, _b;
        __classPrivateFieldSet(this, _CoreAnimation_frameRates, new foundation_1.FramerateCollection({
            parallel: (_a = __classPrivateFieldGet(this, _CoreAnimation_options, "f")) === null || _a === void 0 ? void 0 : _a.parallel,
            infinite: (_b = __classPrivateFieldGet(this, _CoreAnimation_options, "f")) === null || _b === void 0 ? void 0 : _b.infinite,
...
_CoreAnimation_features = new WeakMap(), _CoreAnimation_frameRates = new WeakMap(), _CoreAnimation_options = new WeakMap(), _CoreAnimation_instances = new WeakSet(), _CoreAnimation_createFrameRatesEntries = function _CoreAnimation_createFrameRatesEntries(target) {
    ...
    (Object.entries(__classPrivateFieldGet(this, _CoreAnimation_features, "f")).forEach(({ 0: property, 1: animation }) => {
        entries.push(new foundation_1.Framerate({
            from: animation.from,
            to: animation.to,
