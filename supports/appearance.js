...
exports.CoreAppearance = exports.CoreAppearanceValues = exports.CoreAppearanceProps = void 0;
...
function CoreAppearanceProps(name, value) {
     ...
     */
    keys.forEach(key => {
        parsed[(0, utilities_1.UnCamelize)(key)] = CoreAppearanceValues(value);
    });
    return parsed;
}
...
class CoreAppearance {
    ...
    sheet(stylesheet) {
        ...
        Object.entries(stylesheet).forEach(({ 0: name, 1: props }) => {
            ...
            styleSheet[styleSheet.length] = `${selector}{ ${(0, utilities_1.ObjectToString)(data, { joiner: '; ' })} }`;
        });
    ...
    sync() {
        ...
        Object.entries(this.properties).forEach(({ 0: name, 1: value }) => {
            if (typeof value == 'string' || typeof value == 'number') {
                rendering[rendering.length] = `${(0, utilities_1.UnCamelize)(name)} : ${value}`;
            }
        });
